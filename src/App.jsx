...
style={{ background:g.tint, borderRadius:tabLeftRadius, height:50, border:“none”, cursor:“pointer”, display:“flex”, alignItems:“center”, justifyContent:“center”, borderBottom: activeType === “cue” ? “2px solid transparent” : “2px solid #fff” }}>
...
style={{ background:g.tint, borderRadius:tabRightRadius, height:50, border:“none”, cursor:“pointer”, display:“flex”, alignItems:“center”, justifyContent:“center”, borderBottom: activeType === “contour” ? “2px solid transparent” : “2px solid #fff” }}>
...
<div style={{ background:g.tint, borderRadius:contentRadius, overflowY:“auto”, maxHeight:“60vh”, WebkitOverflowScrolling:“touch” }}>
...
{/* Thin rule */}
<div style={{ height:“1px”, background:”#e0ddd8”, marginBottom:0 }}/>
...
```
  ...
  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:G }}>
    <button onClick={() => handleTab("here")} style={{
      ...
      borderBottom: activeTab === "here" ? "1.5px solid #1a1a1a" : "1.5px solid transparent",
      opacity: activeTab === "now" ? 0.35 : 1,
      transition:"opacity .2s",
    }}>
      <span style={{ fontSize:16, fontWeight:400, color:"#1a1a1a", letterSpacing:"0em", fontFamily:"DM Sans, sans-serif" }}>here</span>
    </button>
    <button onClick={() => handleTab("now")} style={{
      background:"none", border:"none", cursor:"pointer",
      padding:"12px 0", display:"flex", justifyContent:"center",
      borderBottom: activeTab === "now" ? "1.5px solid #1a1a1a" : "1.5px solid transparent",
      opacity: activeTab === "here" ? 0.35 : 1,
      transition:"opacity .2s",
    }}>
      <span style={{ fontSize:16, fontWeight:400, color:"#1a1a1a", letterSpacing:"0em", fontFamily:"DM Sans, sans-serif" }}>now</span>
    </button>
  </div>

  {/* Content -- generous white space */}
  {activeTab && (
    <div style={{ paddingTop:20, paddingBottom:32, animation:"openCard .2s ease" }}>
      {activeTab === "here" && (
        <div>
...
<style>{`* { box-sizing:border-box; margin:0; padding:0; } button { cursor:pointer; font-family:Inter,sans-serif; } ::-webkit-scrollbar { display:none; } @keyframes openCard { from{opacity:0;transform:scaleY(0.96)} to{opacity:1;transform:scaleY(1)} } @keyframes pulse { 0%,100%{opacity:1} 50%{opacity:0.3} }`}</style>
  ...
  {screen === "home" && (
    <div style={{ paddingBottom:90 }}>
      <div style={{ padding:"52px 24px 28px" }}>
        ...
        <p style={{ fontSize:10, fontWeight:300, color:"#bbb", letterSpacing:"0.08em", textTransform:"uppercase", marginTop:14 }}>tap to read . underline to select</p>
      </div>
  ...
  {screen === "prompt" && (
    <div style={{ paddingBottom:90 }}>
      <div style={{ padding:"52px 24px 24px" }}>
        ...
        <p style={{ fontSize:11, fontWeight:300, color:"#bbb", letterSpacing:"0.02em" }}>tap here . now to generate</p>
      </div>
      <div style={{ padding:"0 24px" }}>
        {selCue && selContour ? (
          <div>
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:G, background:GL, marginBottom:0 }}>
              <div style={{ background:getGroup(selCue.group).tint, borderRadius:cr(getItemPos(selCue,"cue"),"left"), height:64, display:"flex", alignItems:"center", justifyContent:"center" }}>
              ...
              <div style={{ background:getGroup(selContour.group).tint, borderRadius:cr(getItemPos(selContour,"contour"),"right"), height:64, display:"flex", alignItems:"center", justifyContent:"center" }}>
  ...
  <div style={{ position:"fixed", bottom:0, left:"50%", transform:"translateX(-50%)", width:"100%", maxWidth:390, zIndex:100, background:"#fff", borderTop:"1px solid #e0ddd8", padding:"10px 24px 28px", display:"flex", alignItems:"center", justifyContent:"flex-end" }}>
    {screen === "home" ? (
      ...
      <div style={{ display:"flex", alignItems:"center", gap:6, flexWrap:"wrap", justifyContent:"flex-end" }}>
        ...
        <button onClick={() => setScreen("home")} style={{ background:"#1a1a2e", color:"#fff", border:"none", borderRadius:20, padding:"7px 14px", fontSize:11, fontWeight:500, letterSpacing:"0.04em", cursor:"pointer" }}>
          read
        </button>
      </div>
    )}
